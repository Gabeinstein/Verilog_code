...
HD_PWD='D:/Coding/Verilog/prelab_6/prelab_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log direccionales.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source direccionales.tcl
