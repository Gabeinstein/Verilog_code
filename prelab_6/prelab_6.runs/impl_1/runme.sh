...
HD_PWD='D:/Coding/Verilog/prelab_6/prelab_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log direccionales.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source direccionales.tcl -notrace
