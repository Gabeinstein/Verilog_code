...
HD_PWD='D:/Coding/Verilog/lab_ultimo/lab_ultimo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modulo_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modulo_display.tcl -notrace
