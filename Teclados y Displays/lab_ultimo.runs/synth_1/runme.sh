...
HD_PWD='D:/Coding/Verilog/lab_ultimo/lab_ultimo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modulo_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modulo_display.tcl
