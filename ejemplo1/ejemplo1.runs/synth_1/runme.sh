...
HD_PWD='D:/Coding/Verilog/ejemplo1/ejemplo1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log circuito1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source circuito1.tcl
