...
HD_PWD='D:/Coding/Verilog/ejemplo1/ejemplo1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log circuito1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source circuito1.tcl -notrace
